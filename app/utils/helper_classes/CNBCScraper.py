class CNBC_Scraper:
    ...
    def extract_content(self) -> str:
        ...
        if all_paragraphs:
            ...
            for div_tag in all_paragraphs.find_all("div", class_="PlayButton-container"):
                div_tag.decompose()

            # Remove <div> tags with the id "RegularArticle-RelatedQuotes"
            for div_tag in all_paragraphs.find_all("div", id="RegularArticle-RelatedQuotes"):
                div_tag.decompose()

            # Remove <div> tags with the id "RegularArticle-RelatedContent-1"
            for div_tag in all_paragraphs.find_all("div", id="RegularArticle-RelatedContent-1"):
                div_tag.decompose()
